package com.summertaker.keyakizaka46blog;
...
import com.summertaker.keyakizaka46blog.common.BaseActivity;
import com.summertaker.keyakizaka46blog.common.BaseApplication;
import com.summertaker.keyakizaka46blog.common.Config;
import com.summertaker.keyakizaka46blog.data.Article;
import com.summertaker.keyakizaka46blog.parser.Keyakizaka46Parser;
import com.summertaker.keyakizaka46blog.util.EndlessScrollListener;
...
public class MainActivity extends BaseActivity implements BlogInterface {
    ...
    */
    ...
    private void loadData() {
        ...
        String url = "http://www.keyakizaka46.com/mob/news/diarKiji.php?site=k46o&ima=0000&cd=member";
        if (mCurrentPage > 1) {
            url += "&rw=20&page=" + mCurrentPage;
